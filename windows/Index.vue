<template>
    <div class="home">
        ...
        <h1>欢迎使用 Electron 应用22267</h1>
        <p>这是一个基础的 Electron 应用程序。</p>
        <button @click="callGitHubAPI">获取 GitHub 数据</button>
...
export default {
  ...
  methods: {
    ...
    // @mainProcess
    testMainProcess(redererTxt, arg2) {
        return window.electron.callMainFunction('__FUNCTION_E:_work_electron_electron-infrastructure_windows_Index_vue_testMainProcess_0__', { redererTxt: redererTxt, arg2: arg2 });
    },

    // 带回调的主进程函数示例
    // @mainProcess
    startMonitoring() {
        return window.electron.callMainFunction('__FUNCTION_E:_work_electron_electron-infrastructure_windows_Index_vue_startMonitoring_0__', {});
    },
    ...
    // @mainProcess
    openDialog() {
        return window.electron.callMainFunction('__FUNCTION_E:_work_electron_electron-infrastructure_windows_Index_vue_openDialog_0__', {});
    },
